...
import com.pickaboo.api.model.Comment;
import com.pickaboo.api.model.Post;
import com.pickaboo.api.model.entity.*;
import com.pickaboo.api.repository.*;
...
public class PostService {
    ...
    public Post modify(String title, String body, String userName, Integer postId) {
        ...
        if (postEntity.getUser() != userEntity) {
            throw new PickabooApiApplicationException(ErrorCode.INVALID_PERMISSION, String.format("%s has no permission with %s", userName, postId));
        }
    ...
    public void like(Integer postId, String userName) {
        ...
        likeEntityRepository.findByUserAndPost(userEntity, postEntity).ifPresent(it -> {
            throw new PickabooApiApplicationException(ErrorCode.ALREADY_LIKED, String.format("userName %s already like post %d", userName, postId));
        });
    ...
    private PostEntity getPostEntityOrException(Integer postId) {
        return postEntityRepository.findById(postId).orElseThrow(() ->
                new PickabooApiApplicationException(ErrorCode.POST_NOT_FOUND, String.format("%s not founded", postId)));
    }
